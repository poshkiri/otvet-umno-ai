...
const schema = z.object({
  ...
  OPENAI_IMAGE_EDIT_MODEL: z.string().default("gpt-image-1"),
  ...
  PLUS_SUBSCRIPTION_STARS: z.coerce.number().int().positive().default(399),
  PLUS_REQUEST_LIMIT: z.coerce.number().int().positive().default(100),
